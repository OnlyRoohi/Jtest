...
def convert_video_to_text_cmd(_, message: Message):
    if not message.reply_to_message or not (message.reply_to_message.video or message.reply_to_message.document):
        return message.reply_text("Please reply to a valid video file.")

    msg = message.reply_text("Processing video to text...")
    ...
    try:
        ...
        message.reply_text(f"Error converting video: {e}")
    finally:
