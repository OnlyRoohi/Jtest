...
from MADARAMUSIC.plugins.tools.pretenderdb import (
    impo_off, impo_on, check_pretender,
    add_userdata, get_userdata, usr_data
)
from MADARAMUSIC.utils.admin_filters import admin_filter
from config import START_IMG_URLS
...
""".format(
    ...
    if msg != "":
        await message.reply_photo(random. choice(START_IMG_URLS), caption=msg)
